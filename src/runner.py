...
# trace_file_name     = 'scarab/scarab.recs.trace.20160808T073231Z.15M_req.1000K.3DSs.csv'
...
missp   = 100
DS_sizes = [10000] #[1000, 2000, 4000, 8000, 16000, 32000]
k_loc   = 1
bpe     = 14
max_fpr = 0.03
max_fnr = max_fpr 
...
uIntervals = [512, 256] #[8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16]
